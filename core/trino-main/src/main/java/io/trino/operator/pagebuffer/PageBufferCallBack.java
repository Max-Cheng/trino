...
{
    boolean addPages(PageBufferResolver client, List<Slice> pages);

    void requestComplete(PageBufferResolver client);

    void clientFinished(PageBufferResolver client);

    void clientFailed(PageBufferResolver client, Throwable cause);
}
