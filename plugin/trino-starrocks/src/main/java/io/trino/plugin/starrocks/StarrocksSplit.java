...
{
    private static final int INSTANCE_SIZE = instanceSize(StarrocksSplit.class);
    private static final int LONG_INSTANCE_SIZE = instanceSize(Long.class);
    ...
    public long getRetainedSizeInBytes()
    {
        return INSTANCE_SIZE
                ...
                + estimatedSizeOf(tabletId, (Long _) -> LONG_INSTANCE_SIZE)
                + estimatedSizeOf(beNode)
